...
def plot_SEM(
    ...
    Parameters:
        ...
        x_ind (np.ndarray): x-coordinates of the data points.
        baseline_fr (slice, optional): Slice object defining the baseline frame range. Default is slice(25, 30 + 1).
    ...
    x_ax = np.arange(x_ind[0], x_ind[-1])
    try:
        if arr.ndim == 2:
