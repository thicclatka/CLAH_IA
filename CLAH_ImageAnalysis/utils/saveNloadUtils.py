...
def savedict2file(
    ...
    if file_suffix:
        fname_save = fname_save + "_" + file_suffix
    if date:
        fname_save = fname_save + "_" + get_current_date_string()
...
def load_json_file(
    filename: str, multiobj: bool = False, list2append: list | None = None
) -> dict:
    """
...
def load_segDict(
    filename: str, all: bool = False, keep_A_sparse: bool = False, **kwargs
